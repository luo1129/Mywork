...
public class XListView extends ListView implements AbsListView.OnScrollListener {
	...
	private void initWithContext(Context paramContext) {
		...
		this.mHeaderViewContent = ((RelativeLayout) this.mHeaderView
				.findViewById(2131296410));
		this.mHeaderTimeView = ((TextView) this.mHeaderView
				.findViewById(2131296413));
		...
		this.mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(
				new ViewTreeObserver.OnGlobalLayoutListener() {
					public void onGlobalLayout() {
						XListView.this.mHeaderViewHeight = XListView.this.mHeaderViewContent
								.getHeight();
	...
	private void updateHeaderHeight(float paramFloat) {
		this.mHeaderView.setVisiableHeight((int) paramFloat
	...
	public void onScroll(AbsListView paramAbsListView, int paramInt1,
		...
		if (this.mScrollListener != null) {
			this.mScrollListener.onScroll(paramAbsListView, paramInt1,
					paramInt2, paramInt3);
		}
	}
	...
	public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt) {
		if (this.mScrollListener != null) {
			this.mScrollListener.onScrollStateChanged(paramAbsListView,
					paramInt);
		}
	}
		...
		case 1:
			for (;;) {
				...
				if ((getFirstVisiblePosition() == 0)
						&& ((this.mHeaderView.getVisiableHeight() > 0) || (f > 0.0F))) {
	...
	public static abstract interface OnXScrollListener extends
 ...
 * Qualified Name: com.XListView JD-Core Version: 0.7.1
 */